...
/*  Section #4:  AJAX code to send the HTTP Request, which is the location the user specifies, to the 
    ...
    Activity 1:  Add your APIXU API KEY in the code below.  This KEY can be retreived by visiting the 
                 ...
                 Use the following code as an example:
                     ...
                     url: 'http://api.apixu.com/v1/current.json?key=bab54b72440145ccbf8174457162504&q=,
...
*/
        ...
        $(document).ready(function(){
           $(':button').click(function(){
                ...
                $.ajax({
                      type: 'GET',
                      url: 'https://api.apixu.com/v1/forecast.json?key=bab54b72440145ccbf8174457162504',
                      data: message             
                })
                .done(function(json){
